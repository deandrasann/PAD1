...
@section('content')
    <div class="container mt-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <form action="{{ route('jumlah-apoteker') }}" method="GET">
                <div class="search-bar mt-2">
                    <input type="text" class="form-control" placeholder="Cari Apoteker" name="search"
                    ...
                    @forelse ($data_apoteker as $index => $item)
                        <tr>
                            ...
                            <td class="d-flex justify-content-center align-items-center">
                                <!-- Edit Button -->
                                <button class="btn btn-success editPasien p-2 px-3 mx-2"
                                    onclick="openEditApotekerModal({{ $item->id_apoteker }})"
                                    id="editApoteker{{ $item->id_apoteker }}">
        ...
        <div class="modal fade" id="editApotekerModal" tabindex="-1" aria-labelledby="editApotekerModalLabel"
            aria-hidden="true">
                    ...
                    <form action="" method="POST" id="formedit">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="namaapotekeredit" name="nama_apoteker"
                                        required>
                                </div>
                            </div>
                        </div>
        ...
        @foreach ($data_apoteker as $key)
            <div class="modal fade" id="hapusApotekerModal{{ $key->id_apoteker }}" tabindex="-1"
                aria-labelledby="hapusApotekerModalLabel" aria-hidden="true">
