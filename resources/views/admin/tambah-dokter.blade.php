            ...
            <form id="create-dokter-form" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('nama_dokter') is-invalid @enderror" id="namadokter" name="nama_dokter" placeholder="Nama Dokter" value="{{ old('nama_dokter') }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('jenis_dokter') is-invalid @enderror" id="jenis_dokter" name="jenis_dokter" placeholder="Jenis Dokter" value="{{ old('jenis_dokter') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('spesialis') is-invalid @enderror" id="spesialis" name="spesialis" placeholder="Spesialis" value="{{ old('spesialis') }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('kode_dokter') is-invalid @enderror" id="kode_dokter" name="kode_dokter" placeholder="Kode Dokter" value="{{ old('kode_dokter') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('kode_bpjs') is-invalid @enderror" id="kode_bpjs" name="kode_bpjs" placeholder="Kode Dokter" value="{{ old('kode_bpjs') }}">
                ...
                <div class="row">
                    <div class="col-md-12 text-end">
                        <button type="button" class="btn btn-secondary me-2" onclick="document.location='{{route('jumlah-dokter')}}'">Kembali</button>
